...
- Variable limits (ex: 128 total variables for the whole mode global, and 128 for player variables)
- Rule/action limits
- Runtime performance 
- Array size (ex: 1000 maximum for a 1 dimensional array)
- Update frequency
...
data-sharing systems when available if the gamemode is pushing the limits of workshop.
